...
def host_imagecache_create(context, values):
    ...
    """
    return IMPL.host_imagecache_create(context, values)

def host_imagecache_update(context, values):
    #NOTE:be careful to guaratee the host and image exsit
    """
    :param values: a dict like values={
                'cache_id':"dsfdsf",
                'host':'gb09',
    ...
    """
    return IMPL.host_imagecache_update(context, values)

def host_imagecache_delete(context, host, cache_id):
    return IMPL.host_imagecache_delete(context, host, cache_id)

def host_imagecache_get_all_by_host(context, host):
    """
    :param host: the host_name ,a string
    """
    return IMPL.host_imagecache_get_all_by_host(context, host)

def host_imagecache_get(context, host, cache_id):
    return IMPL.host_imagecache_get(context, host, cache_id)

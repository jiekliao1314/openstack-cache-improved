...
class ConductorAPI(object):
    ...
    * Remove notify_usage_exists()
    ...
    def host_imagecache_update(self, context, values):
        cctxt = self.client.prepare()
        return cctxt.call(context, 'host_imagecache_update',
                          values=values)

    def host_imagecache_delete(self, context, host, cache_id):
        cctxt = self.client.prepare()
        return cctxt.call(context, 'host_imagecache_delete',
                          host=host,
                          cache_id=cache_id)

    def host_imagecache_get_all_by_host(self, context, host):
        cctxt = self.client.prepare()
        return cctxt.call(context, 'host_imagecache_get_all_by_host',
                            host=host)

    def host_imagecache_get(self, context, host, cache_id):
        cctxt = self.client.prepare()
        return cctxt.call(context, 'host_imagecache_get',
                            host=host,
                            cache_id=cache_id)

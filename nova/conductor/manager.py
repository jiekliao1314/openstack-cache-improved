...
class ConductorManager(manager.Manager):
    ...
    def host_imagecache_update(self, context, values):
        return self.db.host_imagecache_update(context, values)

    def host_imagecache_delete(self, context, host, cache_id):
        return self.db.host_imagecache_delete(context, host, cache_id)

    def host_imagecache_get_all_by_host(self, context, host):
        return self.db.host_imagecache_get_all_by_host(context, host)

    def host_imagecache_get(self, context, host, cache_id):
        return self.db.host_imagecache_get(context, host, cache_id)
